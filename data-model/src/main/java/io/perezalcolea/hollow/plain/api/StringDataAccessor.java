...
public class StringDataAccessor extends AbstractHollowDataAccessor<HString> {
    ...
    public StringDataAccessor(HollowReadStateEngine rStateEngine, BooksAPI api) {
        super(rStateEngine, TYPE);
        this.api = api;
    }

    public StringDataAccessor(HollowReadStateEngine rStateEngine, BooksAPI api, String ... fieldPaths) {
        super(rStateEngine, TYPE, fieldPaths);
        this.api = api;
    }

    public StringDataAccessor(HollowReadStateEngine rStateEngine, BooksAPI api, PrimaryKey primaryKey) {
